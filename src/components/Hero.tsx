...
import selvamLogo from "@/assets/selvam_college_of_technology_logo.jpg";  // import your logo image
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <motion.div
          ...
          className="glass-card inline-flex items-center gap-4 px-8 py-4 mb-8"
        >
          <motion.img
            src={selvamLogo}
            alt="Selvam College Logo"
            className="w-12 h-12 rounded-full shadow-md border border-primary/30"
          ...
          <div className="text-left">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Salem Road (NH 44), Namakkal, Tamil Nadu 637003, India
            </p>
